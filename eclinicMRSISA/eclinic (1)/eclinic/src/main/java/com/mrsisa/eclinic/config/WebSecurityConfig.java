package com.mrsisa.eclinic.config;
...
import com.mrsisa.eclinic.authority.RestAuthenticationEntryPoint;
import com.mrsisa.eclinic.authority.TokenAuthenticationFilter;
...
//				
		...
		public void configure(WebSecurity web) throws Exception {
			...
			web.ignoring().antMatchers(HttpMethod.GET, "/", "/webjars/**", "/*.html", "/favicon.ico", "/**/*.html", "/**/*.css", "/**/*.js", "/**/*.png","/**/*.jpg");
