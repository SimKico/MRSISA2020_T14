...
insert into klinike(klinika_id, grad, naziv_klinike, ocjena_klinike, tip_klinike, kc_id)
values('1','Beograd', 'vma', '5', 1, 'Eclinic');

insert into klinike(klinika_id, grad, naziv_klinike, ocjena_klinike, tip_klinike, kc_id)
values('2','Banjaluka', 'UKC', '5', 2, 'Eclinic');

insert into klinike(klinika_id, grad, naziv_klinike, ocjena_klinike, tip_klinike, kc_id)
values('3','Sarajevo', 'Kosevo', '5', 3, 'Eclinic');